...
class Blockchain {
    ...
    async initializeChain() {
        if( this.height === -1){
            ...
            let block = new BlockClass.Block(genesisBlock);
    ...
    requestMessageOwnershipVerification(address) {
        return new Promise((resolve) => {
            ...
            let message = address + ':' + currentTime + ':starRegistry';
            resolve(message);
        });
    }
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            let msgTimeStamp =  moment.unix(parseInt(message.split(':')[1]));
            ...
            if (timeSinceMessage > 500) {
                ...
                if (!messageValidity) {
                    reject({error: 'Message address, signature is invalid'})
                }else {
                    var newBlock = {
                        body: {
                            star: star,
                    ...
                    let block = new BlockClass.Block(newBlock);
        ...
        return new Promise((resolve, reject) => {
            try {
                self.chain.forEach(function(block){
                    ...
                    BlockClass.Block.getBData(block).then(function(data){
